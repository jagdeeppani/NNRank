function fea = tfidf_l1(fea,bNorm)
...
% tffea = sparse(idx,jdx,vv);

fea2 = tffea';
idf = idf';

MAX_MATRIX_SIZE = 2000; % You can change this number based on your memory.
...
%    fea = NormalizeFea(fea2,0)';
   fea=fea2';
   fea = spdiags(1./sum(fea,2),0,nSmp,nSmp) * fea;
