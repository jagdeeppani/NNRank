...
clear fea;
[m,n] = size(A);
outpath_data = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering/tng_v3/data';
mkdir(outpath_data);
...
outpath_result = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering/tng_v3/result';
mkdir(outpath_result);

for alg_idx = 1:num_algs
    if strcmp(funs_str{alg_idx},'UTSVD')
        disp('UTSVD started');
        outpath_tsvd = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering/tng_v3/tsvd_output';
        mkdir(outpath_tsvd);
        utime=tic;
