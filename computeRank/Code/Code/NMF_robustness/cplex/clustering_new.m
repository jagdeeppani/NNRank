% function Clustering_reuters_v3
...
funs = {@spa,@fast_hull,@ER_spa_svds,@ER_xray_svds};
% funs={@spa,@utsvd};
% Descriptive names for the algorithms
% funs_str = {'Heur_SPA','SPA','XRAY','UTSVD'};
funs_str = {'SPA','XRAY','ER-SPA','ER-XRAY','UTSVD'};
...
clear fea;
[m,n] = size(A);
outpath_data = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_er/rtr_v3/data';
mkdir(outpath_data);
...
outpath_result = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_er/rtr_v3/result';
mkdir(outpath_result);

Accuracy=zeros(num_algs,max_alt_min+1);
nmi_val=zeros(num_algs,max_alt_min+1);
optimization_time=zeros(num_algs,max_alt_min+1);
...
for alg_idx = 1:num_algs
    if strcmp(funs_str{alg_idx},'UTSVD')
        disp('UTSVD started');
        outpath_tsvd = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_er/rtr_v3/tsvd_output';
        mkdir(outpath_tsvd);
        utime=tic;
