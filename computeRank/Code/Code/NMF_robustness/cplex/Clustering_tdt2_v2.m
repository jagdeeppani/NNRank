...
clear fea;
[m,n] = size(A);
outpath_data = '/media/BM/Jagdeep/NMF/cplex/output_clustering_er/tdt2_v2/data';
mkdir(outpath_data);
...
outpath_result = '/media/BM/Jagdeep/NMF/cplex/output_clustering_er/tdt2_v2/result';
mkdir(outpath_result);

for alg_idx = 1:num_algs
    if strcmp(funs_str{alg_idx},'UTSVD')
        disp('UTSVD started');
        outpath_tsvd = '/media/BM/Jagdeep/NMF/cplex/output_clustering_er/tdt2_v2/tsvd_output';
        mkdir(outpath_tsvd);
        utime=tic;
