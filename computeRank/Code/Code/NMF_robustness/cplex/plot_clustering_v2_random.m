function plot_clustering_v2_random(X1, YMatrix1)
...
plot1 = plot(X1,YMatrix1(:,1:end-1),'Parent',axes1,'MarkerSize',8,'LineWidth',2);
...
set(plot1(6),'Marker','d','Color',[0 1 1],'DisplayName','random');

X2=X1-1;
X2(1)=0;
plot2 = plot(X2,YMatrix1(:,end),'Parent',axes1,'MarkerSize',8,'LineWidth',2);
...
% Create title
title('Clustering performance for Reuters','Interpreter','latex',...
    'FontWeight','bold',...
    'FontSize',30);
