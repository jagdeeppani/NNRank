% function Clustering_reuters_v3_er
...
for k_count=1:length(k_arr)
    ...
    for repeat_count=1:no_of_repetitions
        ...
        outpath_data = sprintf('/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_er/rtr_v3/k_%d/rpt_%d/data',k,repeat_count);
        mkdir(outpath_data);
        ...
        outpath_result = sprintf('/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_er/rtr_v3/k_%d/rpt_%d/result',k,repeat_count);
...
outpath_home = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_er/rtr_v3';
