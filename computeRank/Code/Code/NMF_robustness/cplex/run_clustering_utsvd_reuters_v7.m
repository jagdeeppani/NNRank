...
outpath11 = '/home/jagdeep/Documents/NMF/tsvd_cplex/output_clustering_TEMP/reuters8258_tsvd_kmeans2';
mkdir(outpath11);
filename0 = strcat(outpath11,'/anchor_indices_all_reuters_8258.mat');
save(filename0,'anchor_indices_all');
%load anchor_indices_all_reuters.mat;


% Running TSVD
 %outpath = sprintf('/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v2/tsvd_cplex/output/clustering/alt_min_iter');
    outpath = '/home/jagdeep/Documents/NMF/tsvd_cplex/output_clustering_TEMP/reuters8258_tsvd_kmeans2';
    mkdir(outpath);
