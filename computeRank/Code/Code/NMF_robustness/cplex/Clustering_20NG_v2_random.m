function Clustering_20NG_v2_random
...
% funs_str = {'Heur_SPA','SPA','XRAY','UTSVD'};
funs_str = {'random'};
...
clear fea;
[m,n] = size(A);
outpath_data = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_random/tng_v2/data';
mkdir(outpath_data);
...
outpath_result = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_random/tng_v2/result';
mkdir(outpath_result);

for repeat_count=1:10
    ...
    for alg_idx = 1:num_algs
        if strcmp(funs_str{alg_idx},'UTSVD')
            disp('UTSVD started');
            outpath_tsvd = '/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v3/tsvd_cplex/output_clustering_random/tng_v2/tsvd_output';
            mkdir(outpath_tsvd);
            utime=tic;
    ...
    nmi_val_f(repeat_count,:) = nmi_val;
    Total_time_f(repeat_count,:) = Total_time;
    filename4 = strcat(outpath_result,'/nmi_val_f.mat');
    save(filename4,'nmi_val_f');
    
    filename4 = strcat(outpath_result,'/Total_time_f.mat');
    save(filename4,'Total_time_f');
