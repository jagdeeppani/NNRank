function [K, X] = LPsepNMF_cplex_v2(M, epsilon, r, p, model, verbose, varargin)
addpath /home/jagdeep/Desktop/NMF/Experiments/glpkmex-masterr;
...
fprintf('LPsepNMF: glpk took %f secs for %d variables with %d constraints\n',toc,length(f),size(A,1));
%[solution, ~, ~, ~, ~] = cplexlp (f, Aineq, bineq, Aeq, beq, lb, ub);
