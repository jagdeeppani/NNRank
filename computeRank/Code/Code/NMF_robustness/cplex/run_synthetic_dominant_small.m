...
for noise_idx = 1:length(noise_arr)
    ...
    while current_iter<=no_of_iter && loop_count<20
        ...
        for iter_count = current_iter:no_of_iter
            ...
            [A,A_orig,B_orig,C_orig,permute_vect] = generate_synthetic(d,n,k,cw,etta,alpha,beta,normalize);
...
size(M_orig)
                ...
                fprintf('%s : L2 residual norm : (%5.3f) with noise %f\n and iter %d\n', funs_str{alg_idx},res_norm_s_Aorig_temp(alg_idx,iter_count) ,noise_level,iter_count);
