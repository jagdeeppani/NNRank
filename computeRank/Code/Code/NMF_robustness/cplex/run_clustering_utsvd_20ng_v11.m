...
clear fea;
load Twentyng_fea_preprocessed.mat;
...
clear fea;
[m,n] = size(A);
outpath_data = '/home/mas/12/elearitr/Documents/Jagdeep/tsvd-code-birch-v2-cplex/tsvd_cplex_20feb/output_clustering/TNG/data';
mkdir(outpath_data);
...
outpath_result = '/home/mas/12/elearitr/Documents/Jagdeep/tsvd-code-birch-v2-cplex/tsvd_cplex_20feb/output_clustering/TNG/result';
mkdir(outpath_result);

for alg_idx = 1:num_algs
    if strcmp(funs_str{alg_idx},'UTSVD')
        disp('UTSVD started\n');
        outpath_tsvd = '/home/mas/12/elearitr/Documents/Jagdeep/tsvd-code-birch-v2-cplex/tsvd_cplex_20feb/output_clustering/TNG/tsvd_output';
        mkdir(outpath_tsvd);
        utime=tic;
...
for alg_idx=1:num_algs
    ...
    for alt_min_count=0:max_alt_min
        ...
        fprintf('Algorithm: %s, Iteration number: %d',funs_str{alg_idx},alt_min_count);
