function [K,X] = hottopixx_linprog_routine(M,epsilon,r,p,norma,verbose)
...
fprintf('hottTopixx: linprog took %f secs for %d variables with %d constraints\n',toc,length(f),size(Aineq,1) + size(Aeq,1));
