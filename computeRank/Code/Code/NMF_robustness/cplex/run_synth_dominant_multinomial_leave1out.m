...
n = 500; % #of docs
k=10;
noise_arr = [5,10,20,40,60,80,100];
no_of_iter = 5;
...
for noise_idx = 1:length(noise_arr)
    ...
    current_iter=1;
    loop_count=1;
    outpath_residual_norm= sprintf('/home/local/ANT/pjagdeep/NMF_Experiments/synth_dominant_multin_leave1out_500/residual_norm/noise%d',noise_level);
    mkdir(outpath_residual_norm);
    
    outpath_res_norm_db= sprintf('/home/local/ANT/pjagdeep/Dropbox/NMF/synth_dominant_multin_leave1out_500/residual_norm/noise%d',noise_level);
    ...
    while current_iter<=no_of_iter && loop_count<20
        ...
        for iter_count = current_iter:no_of_iter
            ...
            outpath_data = sprintf('/home/local/ANT/pjagdeep/NMF_Experiments/synth_dominant_multin_leave1out_500/data/noise_iter%d_%d',noise_level,iter_count);
            mkdir(outpath_data);
            ...
            for cv_count = 1:length(rd_p)
                ...
                for alg_idx = 1:num_algs
                    if  strcmp(funs_str{alg_idx},'UTSVD')
                        outpath_utsvd = sprintf('/home/local/ANT/pjagdeep/NMF_Experiments/synth_dominant_multin_leave1out_500/tsvd_out/noise_iter%d_%d',noise_level,iter_count);
                        mkdir(outpath_utsvd);
                        tusvd=tic;
                    ...
                    elseif  strcmp(funs_str{alg_idx},'TSVD')
                        outpath_tsvd = sprintf('/home/local/ANT/pjagdeep/NMF_Experiments/synth_dominant_multin_leave1out_500/tsvd_out/noise_iter%d_%d',noise_level,iter_count);
                        mkdir(outpath_tsvd);
                        tusvd=tic;
