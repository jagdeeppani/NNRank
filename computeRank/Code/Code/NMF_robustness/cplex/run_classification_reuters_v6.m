...
for feature_count=1:length(no_of_features)
    ...
    outpath11 = sprintf('/home/jagdeep/Desktop/NMF/Experiments/tsvd-code-birch-v2/tsvd_cplex/output_classification/reuters_full_temp/feature_%d',no_of_features(feature_count));
    mkdir(outpath11);
    ...
    for alg_idx=1:num_algs
        ...
        if strcmp(funs_str{alg_idx},'UTSVD')
            ...
            %mkdir(outpath);
            [M,cluster_id] = TSVD_nowrite(A,outpath11,k);
            disp('M found');
